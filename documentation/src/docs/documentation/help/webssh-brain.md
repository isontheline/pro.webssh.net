...
??? danger "Privacy, Security, Responsibility"
    ...
    * Your data is exclusively utilized to facilitate the creation of SSH commands and scripts, with NO data training conducted. Only data you provide manually is used to generate responses. NO data is collected from your device or any settings and servers you have configured.
