...
## 30.9 - Snowflake (Sleet)
** January 28, 2026 **

| Title | Type of change | Issue |
| --- | --- | --- |
| Ability to choose a different WebSSH App Icon | Added | - |
| Ability to keep device awake if a session is active | Added | [#1503](https://github.com/isontheline/pro.webssh.net/issues/1503) |
| New TAB will move the window to different position on MacOS | Fixed | [#1510](https://github.com/isontheline/pro.webssh.net/issues/1510) |
