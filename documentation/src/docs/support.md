...
!!! bug "WebSSH v32 - Codename Comet :comet:"
    ...
    You can also learn about features [added / changed / removed](/documentation/changelog/32/) inside the next version of WebSSH.
