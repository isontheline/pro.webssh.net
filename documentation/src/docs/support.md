...
!!! bug "WebSSH v33 - Codename Ladybug :lady_beetle:"
    ...
    You can also learn about features [added / changed / removed](/documentation/changelog/33/) inside the next version of WebSSH.
