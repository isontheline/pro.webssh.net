...
## 19.7 - Octopus (Octopodidae)
** September 1, 2022 **

| Title | Type of change | Issue |
| --- | --- | --- |
| Different font size settings for each device type | Added | [#588](https://github.com/isontheline/pro.webssh.net/issues/588) |
| Ability to launch a Tunnel Port Forwarding through a Dynamic Port Forwarding when available | Added | [#683](https://github.com/isontheline/pro.webssh.net/issues/683) |
| Renaming the "Export" menu | Added | [#713](https://github.com/isontheline/pro.webssh.net/issues/713) |
| Improve iOS / iPadOS terminal text selection | Added | [#144](https://github.com/isontheline/pro.webssh.net/issues/144) |
| Since last not able to make selection to copy text | Added | [#718](https://github.com/isontheline/pro.webssh.net/issues/718) |
| No force keyboard interactive toggle in Tunnel tab | Added | [#503](https://github.com/isontheline/pro.webssh.net/issues/503) |
| 2FA : Don't work with tunnels | Added | [#422](https://github.com/isontheline/pro.webssh.net/issues/422) |
| Powershell snippets run in reverse order and do not complete | Fixed | [#708](https://github.com/isontheline/pro.webssh.net/issues/708) |
| App Crash on SSH-Tunnel Error | Fixed | [#719](https://github.com/isontheline/pro.webssh.net/issues/719) |
