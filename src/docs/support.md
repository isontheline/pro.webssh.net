...
[Enroll 14.11 :fontawesome-solid-flask:](/documentation/becoming-external-tester/){: .md-button .md-button--primary }
...
!!! bug "14.11 - Milky Way :milky_way:"
    ...
    You can also learn about features [added / changed / removed](/documentation/changelog/14.11/) inside the next version of WebSSH.
