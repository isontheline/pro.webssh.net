...
[Enroll 14.13 :fontawesome-solid-flask:](/documentation/becoming-external-tester/){: .md-button .md-button--primary }
...
!!! bug "14.13 - Tent :tent:"
    ...
    You can also learn about features [added / changed / removed](/documentation/changelog/14.13/) inside the next version of WebSSH.
