...
!!! success "14.9 - Helicopter :helicopter:"
    ...
    You can also learn about features [added / changed / removed](/documentation/changelog/14.9/) inside the next version of WebSSH.